...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$validation <- c(202102, 202104, 202106)
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    c(ht, ts9), # los inputs
    ranks = c(7), # 1 = el mejor de la bayesian optimization
