...
PARAM$finalmodel$learning_rate <- 0.2155
PARAM$finalmodel$feature_fraction <- 0.999
PARAM$finalmodel$min_data_in_leaf <- 4284
PARAM$finalmodel$num_leaves <- 833
